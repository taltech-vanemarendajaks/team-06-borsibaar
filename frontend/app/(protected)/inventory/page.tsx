                      ...
                      <div>
                        ...
                        <span
                          className={`ml-1 font-semibold ${
                            parseFloat(transaction.quantityChange) >= 0
                              ? "text-green-600"
                              : "text-red-600"
                          }`}
                        >
                          {parseFloat(transaction.quantityChange) >= 0
                            ? "+"
                            : ""}
                          {parseFloat(transaction.quantityChange).toFixed(2)}
                        </span>
                      </div>
                      <div>
                        <span className="text-gray-500">Before:</span>
                        <span className="ml-1 font-semibold">
                          {parseFloat(transaction.quantityBefore).toFixed(2)}
                        </span>
                      </div>
                      <div>
                        <span className="text-gray-500">After:</span>
                        <span className="ml-1 font-semibold">
                          {parseFloat(transaction.quantityAfter).toFixed(2)}
                        </span>
                      </div>
                    </div>
                    {transaction.notes && (
